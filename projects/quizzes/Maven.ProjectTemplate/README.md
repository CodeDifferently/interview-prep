...
## CodeDifferently
* Begin by first ensuring the `main` method in your `CodeDifferently` class prints `"I am coding differently!"` upon execution.  


## Predicate Utilities
* A _predicate_ is a clause which states something about a subject. (_e.g., **is assigning**_ in _"Leon **is assigning** homework"_)
* Ensure each of the test cases passes successfully in the class [TestPredicateUtilities](./src/test/java/hbcu/stay/ready/com/TestPredicateUtilities.java).
...
## Math Utilities
* Ensure each of the test cases passes successfully in the class [TestMathUtilities](./src/test/java/hbcu/stay/ready/com/TestMathUtilities.java) by completing each of the method stubs in the class [MathUtilities](./src/main/java/hbcu/stay/ready/com/MathUtilities.java).
* Method Stubs to be completed	
	* `Integer add(int, int)`
	* `Long add(long, long)`
...
## String Utilities
* Ensure each of the test cases passes successfully in the class [TestStringUtilities](./src/test/java/hbcu/stay/ready/com/TestStringUtilities.java) by completing each of the method stubs in the class [StringUtilities](./src/main/java/hbcu/stay/ready/com/StringUtilities.java).
* Method Stubs to be completed
